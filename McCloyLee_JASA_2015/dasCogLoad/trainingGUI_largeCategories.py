...
# semantic categories
food = ['bread', 'stew', 'meat', 'cake', 'fruit', 'rice']
colors = ['blue', 'gray', 'green', 'pink', 'red', 'tan']
weather = ['hail', 'rain', 'frost', 'wind', 'storm', 'cloud']
furniture = ['bed', 'desk', 'chair', 'lamp', 'stool', 'couch']

allwords = food + colors + weather + furniture
allwords = sorted(allwords)
cats = dict(food=food, colors=colors, weather=weather, furniture=furniture)
